...
public class Point implements PointInterface {
    ...
    /**
     * Equals() - checks for strict equality between an object and our Point class.
     * Returns true if equality is true Returns false if equality is just not there.
     */
    @Override
    ...
    /**
     * inQuadrant - returns true if our point is in the quadrant specified Throws
     * IllegalArgumentException when quardrant is beyond 1-4.
     */
    @Override
    public boolean inQuadrant(int quadrant) throws IllegalArgumentException {
        ...
        case 4:
            return this.x > 0 && this.y < 0;
        default:
            throw new IllegalArgumentException("Quadrant value out of bounds! " + quadrant);
        }
    } 
